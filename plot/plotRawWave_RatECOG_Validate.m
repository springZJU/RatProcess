function Fig = plotRawWave_RatECOG_Validate(chMean, chStd, window, titleStr, plotSize, chs, visible)
    narginchk(3, 7);
    ...
    remapFile = strcat(fileparts(mPath), "\ch_validate_1_32.xlsx");
    ...
    for rIndex = 1:plotSize(1)
        ...
        for cIndex = 1:plotSize(2)
            ...
            chNum = remapIdx(chs(rIndex, cIndex));
