function Fig = plotRawWaveErr_RatECOG(chData, chStd, window, titleStr, plotSize, chs, visible, xlabel)
    narginchk(3, 8);
    ...
    posNum = 0;
    maximizeFig(Fig);
    chMean = chData.chMean;chSE = chData.chSE;
    for rIndex = 1:plotSize(1)
        ...
        for cIndex = 1:plotSize(2)
            ...
            errorbar(t, chMean(chNum, :),chSE(chNum, :),"LineWidth",1.5);hold on;
            hold on;
