...
MATPATH{1} = 'E:\ratNeuroPixel\matData\ECoGRat1\ER20221026\ECoG1\clickTrainLongTerm_3s_124816_1o5\data.mat';
MATPATH{2} = 'E:\ratNeuroPixel\matData\ECoGRat1\ER20221115\ECoG1\clickTrainLongTerm_3s_124816_1o5\data.mat';
...
for mIndex = 1 : length(MATPATH)
    ...
    posStr = temp(6);
    protocolStr = temp(7);
    FIGPATH = strcat(ROOTPATH, "Figure_BaseICI_Awake_Aneasthetic\", protocolStr, "\", DateStr, "\");
    ...
    temp = reshape([ampNorm(1).(strcat(stateStr(mIndex), "_mean"))(sigCh)'; ampNorm(2).(strcat(stateStr(mIndex), "_mean"))(sigCh)';...
        ...
        ampNorm(5).(strcat(stateStr(mIndex), "_mean"))(sigCh)';...
        ...
        ampNorm(5).(strcat(stateStr(mIndex), "_se"))(sigCh)'], 5, []) ;
    ...
    temp = reshape([ampNorm(1).(strcat(stateStr(mIndex), "_mean"))(nSigCh)'; ampNorm(2).(strcat(stateStr(mIndex), "_mean"))(nSigCh)';...
        ...
        ampNorm(5).(strcat(stateStr(mIndex), "_mean"))(nSigCh)';...
        ...
        ampNorm(5).(strcat(stateStr(mIndex), "_se"))(nSigCh)'], 5, []) ;
